...
process_pkl_and_apply_pose(os.path.join(date_folder, 'body_tracking/camera_1/raw', str(1)), (600, 960))
process_pkl_and_apply_pose(os.path.join(date_folder, 'body_tracking/camera_2/raw', str(1)), (600, 960))